...
#include <Windows.h>	// For Windows functionality
...
// Get the handle to the window for more advanced windows programming functionality
DLL_EXPORT HWND GetWindowHandle();
