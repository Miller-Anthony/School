...
{
	{ "Title", &TitleLoad, &TitleInit, &TitleUpdate, &TitleShutdown, &TitleUnload },
	{ "Title", &GameStateStatementLoad, &GameStateStatementInit, &GameStateStatementUpdate, &GameStateStatementShutdown, &GameStateStatementUnload },
	{ "Menu", &MenuLoad, &MenuInit, &MenuUpdate, &MenuShutdown, &MenuUnload },
	{ "Credits", &CreditsLoad, &CreditsInit, &CreditsUpdate, &CreditsShutdown, &CreditsUnload },
	{ "Settings", &SettingsLoad, &SettingsInit, &SettingsUpdate, &SettingsShutdown, &SettingsUnload },
	...
	{ "BattleRoyale", &GameStateBattleRoyaleLoad, &GameStateBattleRoyaleInit, &GameStateBattleRoyaleUpdate, &GameStateBattleRoyaleShutdown, &GameStateBattleRoyaleUnload },
	{ "ArmourShop",	&ArmorShopLoad, &ArmorShopInit, &ArmorShopUpdate, &ArmorShopShutdown, &ArmorShopUnload },
	{ "Town", &GameStateTownLoad, &GameStateTownInit, &GameStateTownUpdate, &GameStateTownShutdown, &GameStateTownUnload },
	{ "PhysicalTown", &GameStatePhysicalTownLoad, &GameStatePhysicalTownInit, &GameStatePhysicalTownUpdate, &GameStatePhysicalTownShutdown, &GameStatePhysicalTownUnload},
	{ "Win", &GameStateWinLoad, &GameStateWinInit, &GameStateWinUpdate, &GameStateWinShutdown, &GameStateWinUnload },
	{ "Lose", &GameStateLoseLoad, &GameStateLoseInit, &GameStateLoseUpdate, &GameStateLoseShutdown, &GameStateLoseUnload },
	{ "PVP", &PVPLoad, &PVPInit, &PVPUpdate, &PVPShutdown, &PVPUnload },
	{ "PVP Game State", &GameStatePVPLoad, &GameStatePVPInit, &GameStatePVPUpdate, &GameStatePVPShutdown, &GameStatePVPUnload},
	{ "PVP Equip State", &GameStatePVPEquipLoad, &GameStatePVPEquipInit, &GameStatePVPEquipUpdate, &GameStatePVPEquipShutdown, &GameStatePVPEquipUnload},
	{ "SaveSelect", &SaveSelectLoad, &SaveSelectInit, &SaveSelectUpdate, &SaveSelectShutdown, &SaveSelectUnload},
	{ "GsTutorial", &GameStateTutorialLoad, &GameStateTutorialInit, &GameStateTutorialUpdate, &GameStateTutorialShutdown, &GameStateTutorialUnload},
	{ "GsBREnd", &GameStateBREndLoad, &GameStateBREndInit, &GameStateBREndUpdate, &GameStateBREndShutdown, &GameStateBREndUnload},
};
